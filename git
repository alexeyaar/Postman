...
console.log("item_6_type == " + typeof item_6); // Вывести в консоль тип данных item_6 в виде “item_6_type == ”

console.log("item_6  —— " + typeof item_6); // Вывести в консоль тип данных item_6 в виде item_6_type ——  


let item_7 = item_6 + item_4; //Создать переменную item_7 и в ней преобразовать item_6 в String.

let item_7_typeof = item_7; // Создать переменную item_7_type . Присвоить переменной item_7_type тип переменной item_7

console.log("item_7 == " + typeof item_7); // Вывести в консоль тип данных item_7 в виде ——  item_7 == 

console.log("item_7 " + typeof item_7); // Вывести в консоль тип данных item_7 в виде ——  item_7

console.log("item_7_type == " + typeof item_7); // Вывести в консоль тип данных item_7 в виде —— “item_7_type == ”

console.log("item_7 —— " + typeof item_7); // Вывести в консоль тип данных item_7 в виде —— item_7_type ——
...
if (age_1 > age_3){
	...
	console.log ('Keep calm and look Culture channel')//  Если age_1  > age_3, вывести в консоль “Keep calm and look Culture channel”.
}
else {
